...
/** CMSIS-NN object used for dynamic quantization.
 *   
 */
typedef struct
{
    int8_t *mean;   /**< Mean value */
    int8_t *std;    /**< Standard deviation value */
} cmsis_nn_filter_stats;
...
{
    int32_t input_offset;  /**< The negative of the zero value for the input tensor */
    int32_t sampling_stride; /** The stride used in the estimation of quantization parameters */
    cmsis_nn_tile stride;
    cmsis_nn_tile padding;
    cmsis_nn_tile dilation;
    cmsis_nn_activation activation;
} cmsis_nn_conv_dynamic_params;
