...
#include "../test_arm_fully_connected_dynamic_s8.c"
#include "unity.h"
...
void test_fully_connected_arm_fully_connected_dynamic_s8(void) { fully_connected_arm_fully_connected_dynamic_s8(); }
