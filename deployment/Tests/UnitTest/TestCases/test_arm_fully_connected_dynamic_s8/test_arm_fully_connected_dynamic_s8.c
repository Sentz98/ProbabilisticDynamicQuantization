...
void fully_connected_arm_fully_connected_dynamic_s8(void)
{
    ...
    filter_stats.mean = FULLY_CONNECTED_WEIGHT_MEAN;
    filter_stats.std = FULLY_CONNECTED_WEIGHT_STD;
    printf("REFERENCE MULTIPLIER: %d\n", FULLY_CONNECTED_OUTPUT_MULTIPLIER); 
    printf("REFERENCE SHIFT %d\n", FULLY_CONNECTED_OUTPUT_SHIFT);
    ...
    arm_cmsis_nn_status result = arm_fully_connected_dynamic_s8(&ctx,
                                                        &fc_params,
                                                        &input_dims,
                                                        input_data,
                                                        &filter_dims,
