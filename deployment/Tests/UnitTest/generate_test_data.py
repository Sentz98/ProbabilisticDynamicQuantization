...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('-t',
                        ...
                        default=None,
                        choices=[
                            'conv','conv_dyn', 'depthwise_conv', 'avgpool', 'maxpool', 'fully_connected', 'softmax', 'svdf', 'add',
    ...
    parser.add_argument('--dynconv', type=int, nargs=8, default=[3,3,3,3,3,3,1,1],
                        help="DYNAMIC CONV CONF: in_ch, out_ch, x_in, y_in, w_x, w_y, stride_x, stride_y")
...
def main():
    ...
    if args.run_all_testsets:
        ...
        try:
            ...
            if test_type == 'conv_dyn':
                generator = ConvSettings(
                                testdataset, 
                                test_type, 
                                True, 
                                True, 
                                ...
                                w_x=conv_conf[4],
                                w_y=conv_conf[5],
                                stride_x=conv_conf[6],
                                stride_y=conv_conf[7],
                                )
